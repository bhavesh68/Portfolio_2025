...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Front-End', description: 'HTML, CSS, JavaScript, TypeScript, React' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Back-End', description: 'Node.js, Express, Python' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Databases', description: 'MongoDB, PostgreSQL' }
];
